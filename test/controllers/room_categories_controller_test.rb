...
class RoomCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_category" do
    assert_difference('RoomCategory.count') do
      post room_categories_url, params: { room_category: { _id: @room_category._id, hotel: @room_category.hotel, name: @room_category.name } }
    end
  ...
  test "should update room_category" do
    patch room_category_url(@room_category), params: { room_category: { _id: @room_category._id, hotel: @room_category.hotel, name: @room_category.name } }
